  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0b0d12] to-[#0e1a2b] text-gray-200">
      ...
      <section className="text-center py-24 border-b border-blue-900/30">
        ...
        >
          Conocé a los entrenadores que forman parte de{" "}
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <Image
              ...
              alt="Equipo de profesores de Versori Pádel"
              width={1000}
              height={600}
      ...
      <section className="py-16 text-center border-t border-blue-900/30">
        ...
        <motion.a
          href="https://api.whatsapp.com/send?phone=5493794000000&text=Hola!%20Me%20gustaría%20postularme%20como%20profesor%20de%20pádel%20en%20Versori."
          target="_blank"
